export const metadata = {
  title: "Contact Us | Cult Clothing",
  description: "Get in touch with Cult Clothing. Visit our store, call us, or reach out on WhatsApp & Instagram.",
};
    ...
    <section style={{ padding: '60px 0', minHeight: '60vh' }}>
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ display: 'grid', gap: '24px' }}>
          {/* WhatsApp */}
          <a href="https://wa.me/919951565569" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              ...
              <div style={{ color: '#999', fontSize: '0.85rem' }}>+91 99515 65569</div>
            </div>
          </a>

          {/* Instagram */}
          <a href="https://instagram.com/cult.vizag" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              ...
              <div style={{ color: '#999', fontSize: '0.85rem' }}>@cult.vizag</div>
            </div>
          </a>

          {/* Phone */}
          <a href="tel:+919951565569"
            style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '20px', borderRadius: '12px', border: '1px solid #eee', textDecoration: 'none', color: 'inherit' }}>
          ...
          {/* Location */}
          <a href="https://maps.app.goo.gl/dGsn9LjN99XWEney6" target="_blank" rel="noopener noreferrer"
            style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '20px', borderRadius: '12px', border: '1px solid #eee', textDecoration: 'none', color: 'inherit' }}>
            ...
            <div>
              ...
              <div style={{ color: '#999', fontSize: '0.85rem' }}>Vizag, Andhra Pradesh</div>
            </div>
          </a>
        </div>
      </div>
